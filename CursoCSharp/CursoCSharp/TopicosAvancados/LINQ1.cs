...
namespace CursoCSharp.TopicosAvancados
{
    ...
    class LINQ1
    {
        public static void Executar()
        {
            ...
            Console.WriteLine("\n== Chamada ===============");
            //Select serve pra transforme a lista de alunos em apenas uma lista com a apenas os nomes
            var chamada = alunos.OrderBy(a => a.Nome).Select(a => a.Nome);
            foreach (var aluno in chamada)
            {
                Console.WriteLine(aluno); //nao precisa colocar aluno.Nome pq de fato so tem as string 
            }
