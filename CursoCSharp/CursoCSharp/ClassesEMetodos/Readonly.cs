...
namespace CursoCSharp.ClassesEMetodos
{
    ...
    {
        public string Nome;
        public readonly DateTime Nascimento; //readonly nao deixa o valor da variavel mudar, 
        //mas permite setar dentro do construtor uma variavel imutavel (variavel somente leitura)
